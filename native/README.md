...
design space is 1672×941 and is uniformly scaled with letterboxing.
...
The visual smoke covers 27 exact-window fixtures (idle, short typing, 80+
character typing with cursor movement, search, read, code, test, approval,
and failure × owl/cat/bot) and validates
