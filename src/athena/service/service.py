...
class AthenaService:
    ...
    # ------------------------------------------------------------------ #
    # Self-host missions — orchestration lives in
    # :mod:`athena.service.self_host` (P1-10). The facade keeps the public
    # entrypoints; every authority seam (kernel inference, task admission,
    # promotion) still resolves through this service instance.
    # ------------------------------------------------------------------ #
    ...
    # ------------------------------------------------------------------ #
    # Operator interaction — mechanism lives in
    # :mod:`athena.service.interaction` (P1-10). The facade keeps the public
    # entrypoints; kernel transitions, stores, policy, and cancellation all
    # resolve through this service instance.
    # ------------------------------------------------------------------ #
